...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.sc = MplCanvas(self, width=8, height=8, dpi=100)
        ...
        setLayout2.addWidget(QtWidgets.QLabel("Font Size"))            
        setLayout2.addWidget(self.fontSizeSB)
        setLayout2.addWidget(QtWidgets.QLabel("Border Width"))            
        setLayout2.addWidget(self.borderWidthSB)
